...
export const COLOR_THEMES: Record<string, ColorThemeDefinition> = {
  ...
  noir: {
    name: "Full Black (OLED)",
    primary: "#27272a",
    secondary: "#3f3f46",
    accent: "#ffffff",
    glow: "rgba(255, 255, 255, 0.12)",
    gradient: "linear-gradient(135deg, #3f3f46 0%, #27272a 50%, #18181b 100%)",
    btnGradient: "from-zinc-700 via-zinc-800 to-zinc-950 hover:from-zinc-600 hover:to-zinc-900",
    bgDark: "bg-[#000000]",
    bgLight: "bg-[#f4f4f5]",
    borderDark: "border-white/15",
    borderLight: "border-black/15",
